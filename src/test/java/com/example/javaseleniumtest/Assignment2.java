...
public class Assignment2 {
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread.sleep(4000);
        WebElement addElementButton = safariDriver.findElement(By.xpath("//*[@id=\"content\"]/div/button"));
        addElementButton.click();
        Thread.sleep(4000);
        WebElement deleteElementButton = safariDriver.findElement(By.xpath("//*[@id=\"elements\"]/button"));
        ...
        safariDriver.findElement(By.xpath("//*[@id=\"basicBootstrapForm\"]/div[1]/div[1]/input")).sendKeys("John");
        safariDriver.findElement(By.xpath("//*[@id=\"basicBootstrapForm\"]/div[1]/div[2]/input")).sendKeys("Doe");
        Thread.sleep(4000);
        // clear first and last name text
        safariDriver.findElement(By.xpath("//*[@id=\"basicBootstrapForm\"]/div[1]/div[1]/input")).clear();
        safariDriver.findElement(By.xpath("//*[@id=\"basicBootstrapForm\"]/div[1]/div[2]/input")).clear();
        Thread.sleep(4000);
        ...
        safariDriver.findElement(By.xpath("//*[@id=\"basicBootstrapForm\"]/div[4]/div/input")).sendKeys("2397777777");

        //--------------   Checkboxes and Radio buttons   --------------
        safariDriver.findElement(By.cssSelector("#basicBootstrapForm > div:nth-child(5) > div > label:nth-child(1) > input")).click();
        ...
        Select fav_ui_automation_tool_dropdown = new Select(safariDriver.findElement(By.className("ui-selectonemenu")));
